...
const About = () => {
  return (
    <section className={`${styles.paddings} relative z-10`}>
      ...
      >
        <TypingText textStyles="text-center" title="| About Metaversus" />
        <motion.p
          variants={fadeIn("up", "tween", 0.2, 1)}
          className="mt-[8px] font-normal sm:text-[32px] text-[20px] text-center text-secondary-white "
        >
          <span className="font-kextrabold text-white">Metaverse </span>
          ...
          of today, using only{" "}
          <span className="font-kextrabold text-white">VR </span>devices you
          easily explore the metaverse world you want, turn your dreams into
          reality. Let&apos;s{" "}
          <span className="font-kextrabold text-white">explore </span>the
